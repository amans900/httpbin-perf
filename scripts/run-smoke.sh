...
# HTML report
docker run --rm   -v "$PWD/jmeter":/jmeter   -w /jmeter   jmeter:5.6.3   -g results/${SCENARIO}.jtl -o results/smoke/html

echo "Report ready: jmeter/results/smoke/html/index.html"